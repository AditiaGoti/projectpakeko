...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class=" col-xl-2 col-lg-6 mb-4" onclick="window.location='/cileungsi/transaksi';">
            ...
            <div class="col-xl-2 col-lg-6 " onclick="window.location='/cileungsi/transaksi';">
                <div class="card card-stats mb-4 mb-xl-0">
                    <div class="card-body">
                        <div class="row">
            ...
            <div class="col-xl-2 col-lg-6 mb-4" onclick="window.location='/cileungsi/allmember';">
                <div class="card card-stats mb-4 mb-xl-0">
                    <div class="card-body">
                        <div class="row">
