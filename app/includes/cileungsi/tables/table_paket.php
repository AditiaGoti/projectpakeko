            ...
            <div class="col-12">
                <div class="page-header">
                    <h4 class="page-title">Package Data
                        <button id="btnAddowPaket" style="float:right; margin-left:5px; display: none;" type="submit" class="btn btn-outline-primary btn-sm" onclick="window.location.href='/cileungsi/owform_paket'">Tambah</button>
                        <button id="btnAddPaket" style="float:right; margin-left:5px; display: none;" type="submit" class="btn btn-outline-primary btn-sm" onclick="window.location.href='/cileungsi/form_paket'">Tambah</button>
                    </h4>
                    <script>
