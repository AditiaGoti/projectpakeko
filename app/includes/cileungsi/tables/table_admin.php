            ...
            <div class="col-12">
                <div class="page-header">
                    <h4 class="page-title">Data Admin
                        ...
                        <button style="display: block;" id="btnAddow" type="submit" class="btn btn-outline-primary btn-sm" onclick="window.location.href='/cileungsi/owform_admin'">Tambah</button>
                    </h4>
                </div>
            </div>
        </div>
