        ...
        <div class="row page-title-header">
            <div class="col-12">
                <div class="page-header">
                    ...
                    <button id="btnAddowTransaksi" style="margin-left: 800px; display: none;" type="submit" class="btn btn-primary" onclick="window.location.href='/owform_admin'">Tambah</button>
                    <button id="btnAddtransaksi" style="margin-left: 800px; display: none;" type="submit" class="btn btn-primary" onclick="window.location.href='/form_admin'">Tambah</button>
                    <script>
