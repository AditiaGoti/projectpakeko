                    ...
                    <div class="card-body">
                        <nav style="padding-bottom:10px;">
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <a style="display:none;" class="nav-item nav-link active" id="ownav-inactivemember-tab" data-toggle="tab" onclick="window.location.href='/owinactive_member'" role="tab" aria-controls="nav-inactivemember" aria-selected="false">Inactive Member</a>
                                ...
                                <a style="display:none;" class="nav-item nav-link active" id="nav-inactivemember-tab" data-toggle="tab" onclick="window.location.href='/inactive_member'" role="tab" aria-controls="nav-inactivemember" aria-selected="false">Inactive Member</a>
                                <script>
                                    var type = '<?php echo $_SESSION['type']; ?>'
                                    if (type == 2) {
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <script>
                                ...
                                if (type == 2) {
                                    ...
                                    <div class="tab-pane fade show active" id="ownav-inactivemember" role="tabpanel" aria-labelledby="ownav-inactivemember-tab"></div>`
                                } else {
                                    ...
                                    <div class="tab-pane fade show active" id="nav-inactivemember" role="tabpanel" aria-labelledby="nav-inactivemember-tab"></div>`
                                }
                            </script>
                        </div>
