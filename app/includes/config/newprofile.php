                    ...
                    <div class="row m-l-0 m-r-0">
                        <div class="col-sm-4 bg-c-lite-green user-profile">
                            <div class="card-block text-center text-white">
                                <div class="m-b-25"> <img src="assets/images/logoo.png" style="width: 200px; height: 200px;" class="img-radius" alt="User-Profile-Image"> </div>
                        ...
                        <div class="col-sm-8">
                            <div class="card-block" style="padding: 1.25rem;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600">Place of Birth</p>
                                        <h6 class="text-muted f-w-400">98979989898</h6>
                                    </div>
                                    <div class="col-sm-6">
