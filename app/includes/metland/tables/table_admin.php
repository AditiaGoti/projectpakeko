                    ...
                    <div class="modal-body">
                        ...
                        <script>
                            function checkDate() {
                                ...
                                const urlTE = "https://metland.tms-klar.com/api/admins-export";
                            ...
                            <table class="table table-striped table-bordered table-hover" style="width:100%" id="table-data">
                                ...
                                <tbody>
                                    <script>
                                        ...
                                        var token = "Bearer" + " " + tokenSession;
                                        var myArray = [];
                                        const url = "https://metland.tms-klar.com/api/admin";
                                        ...
                                        function deleteData() {
                                            ...
                                            fetch("https://metland.tms-klar.com/api/admin" + "/" + admID, deleteRequest)
                                                .then((res) => res.json())
                                                .then((result => {
                                                    hideLoading()
