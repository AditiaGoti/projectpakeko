            ...
            <div class="col-12">
                <div class="page-header">
                    <h4 class="page-title">Menambahkan Transaksi Klub Ade Rai
                        <button id="owbacktransaksi" style="float:right; margin-left:5px; display: none;" type="submit" class="btn btn-inverse-danger btn-sm" onclick="window.location.href='/ragunan/owtransaksi'">Back</button>
                        <button id="backtransaksi" style="float:right; margin-left:5px; display: none;" type="submit" class="btn btn-inverse-danger btn-sm" onclick="window.location.href='/ragunan/transaksi'">Back</button>
                    </h4>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <script>
                            ...
                            function checkID() {
                                ...
                                fetch(
                                        "https://api.ragunan.tms-klar.com/api/users/" + id,
                                        requestOptions
                                    )
                            ...
                            function daftarTransaksi() {
                                ...
                                fetch(
                                        "https://api.ragunan.tms-klar.com/api/transaksi",
                                        requestOptions
                                    )
                                    .then((response) => response.text())
                                    .then((result => {
