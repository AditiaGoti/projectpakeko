            ...
            <div class="col-12">
                <div class="page-header">
                    <h4 class="page-title">Transaction Data
                        ...
                        <button id="btnAddowTransaksi" style="float:right; margin-left:5px; display: none;" type="submit" class="btn btn-outline-primary btn-sm" onclick="window.location.href='/ragunan/owform_transaksi'">Tambah</button>
                        <button id="btnAddtransaksi" style="float:right; margin-left:5px; display: none;" type="submit" class="btn btn-outline-primary btn-sm" onclick="window.location.href='/ragunan/form_transaksi'">Tambah</button>
                    </h4>
                    <script>
                            ...
                            function checkDate() {
                                ...
                                fetch(urlTE, requestOptions)
                                    ...
                                    .then((result => {
                                        ...
                                        if (type == 2) {
                                            location.href = '/ragunan/set-owtransaksi';
                                        } else {
                                            location.href = '/ragunan/set-transaksi';
                                        }
                                    }))
