            ...
            <div class="col-12">
                <div class="page-header">
                    <h4 class="page-title">Data Admin
                        ...
                        <button style="display: block;" id="btnAddow" type="submit" class="btn btn-outline-primary btn-sm" onclick="window.location.href='/ragunan/owform_admin'">Tambah</button>
                    </h4>
                </div>
            </div>
        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <script>
                            function checkDate() {
                                ...
                                const urlTE = "https://api.ragunan.tms-klar.com/api/admins-export";
                            ...
                            <table class="table table-striped table-bordered table-hover" style="width:100%" id="table-data">
                                ...
                                <tbody>
                                    <script>
                                        ...
                                        var token = "Bearer" + " " + tokenSession;
                                        var myArray = [];
                                        const url = "https://api.ragunan.tms-klar.com/api/admin";
                                        ...
                                        function deleteData() {
                                            ...
                                            fetch("https://api.ragunan.tms-klar.com/api/admin" + "/" + admID, deleteRequest)
                                                .then((res) => res.json())
                                                .then((result => {
                                                    hideLoading()
