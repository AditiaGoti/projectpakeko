            ...
            <div class="col-12">
                <div class="page-header">
                    <h4 class="page-title">Merubah Admin Klub Ade Rai
                        <button id="owbackadmin" style="float:right; margin-left:5px; display: none;" type="submit" class="btn btn-inverse-danger btn-sm" onclick="window.location.href='/ragunan/owalladmin'">Back</button>
                    </h4>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <script>
                            ...
                            const url = "https://api.ragunan.tms-klar.com/api/admin" + "/" + admID;
                            ...
                            function build(data) {
                                ...
                                imgv.src = "https://api.ragunan.tms-klar.com/public/storage/" +
                                    data.img_path;
