<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <a class="navbar-brand brand-logo" href="/ragunan/member" style="margin-top: -5px; width: 230px; padding: 3px;">
            <img src="../../../../public/assets/images/aderaifix.png" alt="logo" /></a>
        <a class="navbar-brand brand-logo-mini" href="/ragunan/member">
