                            ...
                            <div class="col-sm-8">
                                <div class="card-block" style="padding: 1.25rem;">
                                    ...
                                    <div class="buttonupdate">
                                        <button id="EPAdmin" style=" display: block; margin-left: 345px; margin-top:70px" class="btn btn-inverse-info btn-fw" onclick="window.location.href='/ragunan/editprofile-admin'">Edit Profile</button>

                                    </div>
                                    <div class="buttoncp">
                                        <button id="CPAdmin" style="display: block; float:right; margin-top: -29px; " class="btn btn-inverse-warning btn-fw" onclick="window.location.href='/ragunan/changepass-admin'">Change Password</button>
