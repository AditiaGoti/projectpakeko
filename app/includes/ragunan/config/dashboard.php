...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class=" col-xl-2 col-lg-6 mb-4" onclick="window.location='/ragunan/transaksi';">
            ...
            <div class="col-xl-2 col-lg-6 " onclick="window.location='/ragunan/transaksi';">
                <div class="card card-stats mb-4 mb-xl-0">
                    <div class="card-body">
                        <div class="row">
            ...
            <div class="col-xl-2 col-lg-6 mb-4" onclick="window.location='/ragunan/allmember';">
                <div class="card card-stats mb-4 mb-xl-0">
                    <div class="card-body">
                        <div class="row">
    ...
    <script>
        ...
        const urlt = "https://api.ragunan.tms-klar.com/api/transaksi";
        const urlm = "https://api.ragunan.tms-klar.com/api/users";
        const urlk = "https://api.ragunan.tms-klar.com/api/kehadiran";
